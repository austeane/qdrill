<script>
    ...
    export let numberOfPeopleOptions = { min: 1, max: 100 };
    export let suggestedLengths = { min: 1, max: 120 };
    ...
    export let selectedNumberOfPeopleMin = numberOfPeopleOptions.min;
    export let selectedNumberOfPeopleMax = numberOfPeopleOptions.max;
    export let selectedSuggestedLengthsMin = suggestedLengths.min;
    export let selectedSuggestedLengthsMax = suggestedLengths.max;
    ...
    {#if skillLevels.length || complexities.length || skillsFocusedOn.length || positionsFocusedOn.length || 
                ...
                >
                    <div class="mb-4">
                        ...
                        <div class="text-center text-sm text-gray-600">
                            {selectedNumberOfPeopleMin} Participants
                        </div>
                    </div>
                    <div>
                        ...
                        <input 
                            type="range" 
                            min={selectedNumberOfPeopleMin} 
                            max={numberOfPeopleOptions.max} 
                            bind:value={selectedNumberOfPeopleMax}
                            class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                        />
                        <div class="text-center text-sm text-gray-600">
                            {selectedNumberOfPeopleMax} Participants
                        </div>
                    </div>
                </div>
            {/if}
        ...
        <div class="relative">
            ...
            {#if showSuggestedLengths}
                ...
                >
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Min Length (mins)</label>
                        <input 
                            type="range" 
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Max Length (mins)</label>
                        <input 
                            type="range" 
                            min={selectedSuggestedLengthsMin} 
                            max={suggestedLengths.max} 
                            bind:value={selectedSuggestedLengthsMax}
                            class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                        />
                        <div class="text-center text-sm text-gray-600">
                            {selectedSuggestedLengthsMax} mins
                        </div>
                    </div>
                </div>
            {/if}
