...
export async function addSidebarElements(elements, files) {
    ...
    const balls = [
        { url: '/images/icons/quaffle.png', x: CANVAS_WIDTH + 100, y: 115, size: { width: 16, height: 20 } },
        { url: '/images/icons/bludger.png', x: CANVAS_WIDTH + 160, y: 115, size: { width: 16, height: 20 } },
        { url: '/images/icons/bludger.png', x: CANVAS_WIDTH + 220, y: 115, size: { width: 16, height: 20 } },
        { url: '/images/icons/bludger.png', x: CANVAS_WIDTH + 280, y: 115, size: { width: 16, height: 20 } },
        { url: '/images/cone.webp', x: CANVAS_WIDTH + 340, y: 115, size: { width: 20, height: 20 }, scale: [0.25, 0.25] }
    ];
