    ...
    <div class="bg-white shadow-md rounded-lg p-6 mb-8">
      ...
      <div class="flex justify-center space-x-4 mb-6">
        ...
        {:else}
          ...
          >
            Mark as Variant
            <div class="pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg whitespace-nowrap">
